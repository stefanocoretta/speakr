...
If the script logs results to a file, the file is created in the same directory as the one of the script, as expected, and nothing is returned in R. To load the results file in R, just read it in as you would with any other dataset.
